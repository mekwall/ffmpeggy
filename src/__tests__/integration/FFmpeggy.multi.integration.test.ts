...
describe("FFmpeggy:multi", () => {
  ...
  describe("Debug", () => {
    it(
      "should run a simple FFmpeg command",
      async () => {
        ...
        await TestAssertions.expectFileExists(outputFile);
      },
      TEST_TIMEOUT_MS
    );
  });
  ...
  describe("Multiple inputs", () => {
    it(
      ...
      async () => {
        ...
        await TestAssertions.expectFileExists(output);
      },
      TEST_TIMEOUT_MS
    );
    ...
    it(
      "should handle mixed audio and video inputs",
      async () => {
        const outputFile = fileManager.createTempFile("mp4");
    ...
    it(
      "should handle different video formats",
      async () => {
        ...
        const ffmpeggy = new FFmpeggy()
          .setInputs([
            SAMPLE_FILES.video_basic_mp4,
            SAMPLE_FILES.video_multi_stream,
          ])
          .setOutput(output1)
          .setOutputOptions(["-c:v", "libx264", "-c:a", "aac"]);
        ...
        await TestAssertions.expectFileExists(output1);
      },
      TEST_TIMEOUT_MS
    );
  });
  ...
  describe("Multiple outputs", () => {
    it(
      "should handle multiple file outputs",
      async () => {
        const output1 = fileManager.createTempFile("mp4");
        ...
        expect(file).toBe(output1);
        await TestAssertions.expectFileExists(output1);
        await TestAssertions.expectFileExists(output2);
      },
      TEST_TIMEOUT_MS
    );
    ...
    it(
      "should handle WebM to MP4 conversion",
      async () => {
        const outputFile = fileManager.createTempFile("mp4");
  ...
  describe("Tee pseudo-muxer", () => {
    it(
      "should use tee pseudo-muxer when useTee() is called",
      async () => {
        const output1 = fileManager.createTempFile("mp4");
        const output2 = fileManager.createTempFile("mkv");
    ...
    it(
      "should use tee pseudo-muxer when tee option is set in constructor",
      async () => {
        const output1 = fileManager.createTempFile("mp4");
        const output2 = fileManager.createTempFile("mkv");
    ...
    it(
      "should not use tee pseudo-muxer by default for multiple outputs",
      async () => {
        const output1 = fileManager.createTempFile("mp4");
        const output2 = fileManager.createTempFile("mkv");
    ...
    it(
      "should use tee with different codecs",
      async () => {
        const output1 = fileManager.createTempFile("mp4");
        const output2 = fileManager.createTempFile("mkv");
    ...
    it(
      "should handle tee with streams",
      async () => {
        const output1 = fileManager.createTempFile("mp4");
        const output2 = fileManager.createTempFile("mkv");
    ...
    it(
      "should handle tee with mixed input types",
      async () => {
        const output1 = fileManager.createTempFile("mp4");
        const output2 = fileManager.createTempFile("mkv");
        const inputStream = fileManager.createInputStream(
  ...
  describe("Backward compatibility", () => {
    it(
      "should maintain backward compatibility with single input/output",
      async () => {
        const outputFile = fileManager.createTempFile("mp4");
    ...
    it(
      "should work with constructor options",
      async () => {
        const outputFile = fileManager.createTempFile("mp4");
  ...
  describe("Complex scenarios", () => {
    it(
      "should handle multiple inputs and outputs",
      async () => {
        const output1 = fileManager.createTempFile("mp4");
        const output2 = fileManager.createTempFile("mkv");
    ...
    it(
      "should handle complex input options",
      async () => {
        const outputFile = fileManager.createTempFile("mp4");
    ...
    it(
      "should handle different resolutions for each output",
      async () => {
        const output1 = fileManager.createTempFile("mp4");
    ...
    it(
      "should handle different bitrates for each output",
      async () => {
        const output1 = fileManager.createTempFile("mp4");
        const output2 = fileManager.createTempFile("mp4");
    ...
    it(
      "should handle different audio codecs for each output",
      async () => {
        const output1 = fileManager.createTempFile("mp4");
        const output2 = fileManager.createTempFile("mkv");
    ...
    it(
      "should handle different quality settings for each output",
      async () => {
        ...
        await TestAssertions.expectFileExists(hdOutput);
        await TestAssertions.expectFileExists(sdOutput);
      },
      TEST_TIMEOUT_MS
    );

    it(
      "should handle different frame rates for each output",
      async () => {
        const output1 = fileManager.createTempFile("mp4");
        const output2 = fileManager.createTempFile("mp4");
    ...
    it(
      "should handle different audio bitrates for each output",
      async () => {
        const output1 = fileManager.createTempFile("mp4");
        const output2 = fileManager.createTempFile("mkv");
    ...
    it(
      "should handle different audio sample rates for each output",
      async () => {
        const output1 = fileManager.createTempFile("mp4");
        const output2 = fileManager.createTempFile("mkv");
